        ...
        return Row(
            ...
            controls=[
                Column(
                    spacing=2,
                    controls=[
                        Text(value=criteria, size=15, weight="bold", color="white"),
                        Text(value=description, size=11, color="white54"),
                    ],
                ),
                Row(
                    spacing=0,
        ...
        return Container(
            ...
            content=Column(
                ...
                controls=[
                    ...
                    Text("Password Strength Check", size=24, weight="bold", color="white"),
                    Text(
